...
class SettingsData:
    ...
    Main Attributes:
        - connector -  An instance of the DatabaseConnector class that is used to connect to and interact with a database
    ...
    Main Operations:
        ...
        - get_setting_data(table_name): Gets all the data from a table in the database and stores it in a dictionary.
        - update_database(table_name, **kwargs): Updates the current SLA/Bot Setting Values and/or the current Home Delivery Setting values to the database.
    """
    ...
    # TODO: Catch exceptions if database doesn't accept the type of parameter inputted.
    def update_database(self, table_name: str, **kwargs):
        """
